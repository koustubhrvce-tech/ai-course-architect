...
export default function Footer() {
  ...
  return (
    <footer className="bg-lms-navy text-white">
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          {/* Brand */}
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-lms-blue">
                <Sparkles className="h-5 w-5 text-white" />
              </div>
              <span className="text-xl font-bold">LearnAI</span>
            </Link>
            <p className="text-sm text-white/60 leading-relaxed">
              AI-powered learning platform that transforms how you teach and learn.
            </p>
          </div>
